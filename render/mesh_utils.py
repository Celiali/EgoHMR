...
# borrowed from https://github.com/mkocabas/PARE/blob/master/pare/utils/mesh_utils.py
import trimesh
import numpy as np
...
def get_world_mesh_list(planeWidth=4, axisHeight=0.7, axisRadius=0.02, add_plane=True):
    ...
    if add_plane:
        ...
        ground = get_checkerboard_plane(plane_width=4, num_boxes=9, center=True)
...
if __name__ == '__main__':
    ...
    scene.add_geometry(get_world_mesh_list(add_plane=True))
    scene.show()